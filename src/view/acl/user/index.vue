...
const save = async () => {
  ...
  //添加或者更新成功
  if (result.code == 200) {
    if (rowName.value == useStore.username) {
      ElMessage({
        type: 'error',
        message: '你不能修改自己的账号',
      })
    ...
    //浏览器自动刷新一次，应对账号用户更改当前账号自动刷新退出到登录页
